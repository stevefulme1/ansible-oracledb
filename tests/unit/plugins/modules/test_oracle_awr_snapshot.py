...
class TestDelete:
    ...
    def test_delete_not_found(self):
        ...
        result = client.delete("awr_snapshot", "x")
...
class TestList:
    ...
    def test_list_empty(self):
        ...
        assert len(client.list("awr_snapshot")) == 0
...
class TestGet:
    def test_get_existing(self):
        ...
        assert client.get("awr_snapshot", "123")["name"] == "test"

    def test_get_not_found(self):
        client = MagicMock()
        client.get.return_value = None
        assert client.get("awr_snapshot", "x") is None
