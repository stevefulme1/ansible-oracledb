...
options:
    ...
    host:
        ...
        required: true
    link_name:
        description: Unique identifier of the db link.
        type: str
    name:
...
EXAMPLES = r"""
- name: Create a db link
  stevefulme1.oracledb.oracle_db_link:
    host: api.example.com
    name: my-db-link
    state: present

- name: Delete a db link
  stevefulme1.oracledb.oracle_db_link:
    host: api.example.com
...
def main():
    module = AnsibleModule(
        ...
        required_if=[("state", "absent", ("link_name",))],
    )
    ...
    if state == "present":
        ...
        if resource_id:
            ...
            candidates = client.list("db_link", {dict(name=module.params.get("name", ""))})
            if candidates:
