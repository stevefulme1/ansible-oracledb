...
DOCUMENTATION = r"""
---
module: oracle_listener_info
short_description: Retrieve listener information
description:
    - Retrieve details about listeners.
    - Read-only module.
version_added: "1.0.0"
author:
...
- name: List all listeners
  stevefulme1.oracledb.oracle_listener_info:
...
def main():
    ...
    if resource_id:
        result = client.get("listener", resource_id)
        ...
        resources = client.list("listener", module.params)

    module.exit_json(changed=False, listeners=resources)
