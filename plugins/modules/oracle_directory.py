...
- name: Create a directory
  stevefulme1.oracledb.oracle_directory:
...
def main():
    module = AnsibleModule(
        ...
        required_if=[("state", "absent", ("dir_name",))],
    )
    ...
    if state == "present":
        ...
        if resource_id:
            ...
            candidates = client.list("directory", {dict(name=module.params.get("name", ""))})
            if candidates:
