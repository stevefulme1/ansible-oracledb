...
short_description: Clone Oracle Pluggable Databases
description:
    - Clone Oracle Pluggable Databases.
version_added: "1.0.0"
author:
...
options:
    ...
    host:
        ...
        required: true
    clone_name:
        description: Unique identifier of the pdb clone.
        type: str
    name:
...
EXAMPLES = r"""
- name: Create a pdb clone
  stevefulme1.oracledb.oracle_pdb_clone:
    host: api.example.com
    name: my-pdb-clone
    state: present

- name: Delete a pdb clone
  stevefulme1.oracledb.oracle_pdb_clone:
    host: api.example.com
...
def main():
    module = AnsibleModule(
        ...
        required_if=[("state", "absent", ("clone_name",))],
    )
    ...
    if state == "present":
        ...
        if resource_id:
            ...
            candidates = client.list("pdb_clone", {dict(name=module.params.get("name", ""))})
            if candidates:
